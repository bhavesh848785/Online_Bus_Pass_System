			 				...
			 				<p>Verify Your old password and Update new one for more security.</p>
							  <form>
								 <div class="form_details">
					                 <input type="text" class="text" value="Old Password" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Name';}">
									 <input type="text" class="text" value="New Password" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Email Address';}">
									 <input type="text" class="text" value="Confirm New Password" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Subject';}">
